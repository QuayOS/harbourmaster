...
/**
 * Called when a message is received on the topic filter given when calling {@link module:util/mqtt-wrapper~MQTTWrapper#registerHandler}.
...
/**
 * Wraps a {@link module:util/mqtt-wrapper~messageHandler}, filtering out calls with
 * topics not matching the topic filter given when calling {@link module:util/mqtt-wrapper~MQTTWrapper#registerHandler}.
 * topics not matching the topic filter given when calling {@link module:util/mqtt-wrapper~MQTTWrapper#registerHandler}.
...
class MQTTWrapper {
   ...
   * @return {void} Resolves when the connection was established.
   */
   ...
   * @return {void} Resolves when the client disconnected.
   */
   ...
   * @param  {module:util/mqtt-wrapper~messageHandler} messageHandler Callback
   * called when a message is received matching the given topic filter.
   * @return {module:util/mqtt-wrapper~messageHandlerWrapper} A wrapper function
   * around the message handler that can be passed to {@link
   * module:util/mqtt-wrapper~MQTTWrapper#unregisterHandler} to later remove
   * this handler.
   */
   ...
   * module:util/mqtt-wrapper~MQTTWrapper#registerHandler}.
   * @param  {module:util/mqtt-wrapper~messageHandlerWrapper} messageHandler The
   * handler returned by {@link
   * module:util/mqtt-wrapper~MQTTWrapper#registerHandler} to be unregistered.
   */
   ...
   * @param  {module:util/mqtt-wrapper~messageHandler} messageHandler The message
   * handler to register with the given filter.
   * @return {module:util/mqtt-wrapper~messageHandlerWrapper?} Resolves when the
   * subscription was successfull, returning the registered wrapper function as
   * documented in {@link module:util/mqtt-wrapper~MQTTWrapper#registerHandler} if a
   * message handler was given.
   */
   ...
   * @return {void} Resolves when the message was published.
   */
