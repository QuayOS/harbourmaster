...
class MQTTWrapper {
   ...
   * @param  {module:util/mqtt-wrapper~messageHandler} messageHandler The
   * message handler to register with the given filter.
   * @return {Promise<module:util/mqtt-wrapper~messageHandlerWrapper?>} Resolves
   * when the subscription was successfull, returning the registered wrapper
   * function as documented in {@link
   * module:util/mqtt-wrapper~MQTTWrapper#registerHandler} if a message handler
   * was given.
   */
