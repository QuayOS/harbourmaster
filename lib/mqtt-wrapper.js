...
/**
 * Called when a message is received on the topic filter given when calling {@link module:mqtt-wrapper~MQTTWrapper#registerHandler}.
...
/**
 * Wraps a {@link module:mqtt-wrapper~messageHandler}, filtering out calls with
 * topics not matching the topic filter given when calling {@link module:mqtt-wrapper~MQTTWrapper#registerHandler}.
...
class MQTTWrapper {
   ...
   * @param  {module:mqtt-wrapper~messageHandler} messageHandler Callback called
   * when a message is received matching the given topic filter.
   * @return {module:mqtt-wrapper~messageHandlerWrapper} A wrapper function
   * around the message handler that can be passed to {@link
   * module:mqtt-wrapper~MQTTWrapper#unregisterHandler} to later remove this
   * handler.
   */
   ...
   * module:mqtt-wrapper~MQTTWrapper#registerHandler}.
   * @param  {module:mqtt-wrapper~messageHandlerWrapper} messageHandler The handler returned by {@link
   * module:mqtt-wrapper~MQTTWrapper#registerHandler} to be unregistered.
   */
   ...
   * @param  {module:mqtt-wrapper~messageHandler} messageHandler The message
   * handler to register with the given filter.
   * @return {module:mqtt-wrapper~messageHandlerWrapper?} Resolves when the
   * subscription was successfull, returning the registered wrapper function as
   * documented in {@link module:mqtt-wrapper~MQTTWrapper#registerHandler} if a
